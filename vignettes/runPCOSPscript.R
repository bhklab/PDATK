...
#   and are assumed to be random. It may be worth checking for correlations
#   between training/testing data to ensure this assumption is valid
...
SEs <- mapply(updateSumExpSurvival, SE=cohortSEs, survivalDT=oldSurvivalData,
    SIMPLIFY=FALSE)
